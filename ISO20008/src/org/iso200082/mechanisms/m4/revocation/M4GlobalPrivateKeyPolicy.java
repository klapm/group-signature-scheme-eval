...
/**
 * Global private key revocation policy, simply derives from the local one
 ...
 * @version 1.0
 */
public class M4GlobalPrivateKeyPolicy
<
  P
>
extends M4LocalPrivateKeyPolicy<P>
{
  @Override
  public RevocationType getRevocationType()
  {
    return RevocationType.GLOBAL_PRIVATEKEY_REVOCATION;
  }
