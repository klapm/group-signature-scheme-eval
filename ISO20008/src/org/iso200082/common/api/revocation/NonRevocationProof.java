...
/**
 * Non-revocation proof issued by the signer on signature revocation
 * checks. No active actions here, just a means to exchange the proof.
 * 
 ...
 */
public interface NonRevocationProof
{
  // intenionally empty.
}
