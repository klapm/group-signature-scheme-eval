 ...
 * CurveField<FqElement, Fq> all the time. 
 * 
...
<
  P
>
extends CurveField<FqElement<P>, Fq<P>>
{
  /**
   * Ctor, initializes the curve field. See
   * {@link CurveField#CurveField(Random, Field, FieldElement, FieldElement, 
   * BigInteger, BigInteger, boolean)}. Strips the 'a' coefficient since it's zero for
   * our purposes.
   * 
   ...
   *                   mix or not
   */
  public G1(Random rnd, Field<FqElement<P>, Fq<P>> field, FqElement<P> b,
